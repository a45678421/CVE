...
def main():
    ...
    # 檢查是否所有的選擇列都存在
    selected_columns = ['Column1.name', 'Column1.layer', 'Column1.version', 'Column1.issue.id', 'Column1.issue.summary', 'Column1.issue.vector', 'Column1.issue.status', 'Column1.issue.scorev2', 'Column1.issue.scorev3', 'Column1.issue.link', 'Column1.redmine.upload']
